...
const TIMELINE = [
  ...
  },
  {
    ...
    date: "19:00 13/04",
    items: [
      "Thuyết trình online – 10 phút/đội.",
            ...
            <div className="w-full lg:w-[55%] p-8 lg:p-16 flex flex-col justify-center">
              ...
              <div className="space-y-4 w-full max-w-xl">
                {TIMELINE.map((phase, index) => (
                  <div 
                    key={index} 
                    className={`liquid-glass rounded-[2rem] overflow-hidden transition-all duration-500 ${
                      activePhase === index ? 'ring-1 ring-white/30 bg-white/10' : 'hover:bg-white/5'
                    }`}
                  >
                    <button 
                    ...
                    >
                      <div className="flex items-center gap-6">
                        <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-colors ${
                          activePhase === index ? 'bg-white text-black' : 'bg-white/10 text-white group-hover:bg-white/20'
                        }`}>
              ...
              <div className="liquid-glass p-6 rounded-[3rem]">
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="liquid-glass p-6 rounded-[2rem] hover:bg-white/5 transition-colors">
                    ...
                    <p className="text-[10px] text-white/50">3 – 4 thành viên</p>
                  </div>
                  <div className="liquid-glass p-6 rounded-[2rem] hover:bg-white/5 transition-colors">
                    <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center mb-4">
